...
// Type for the responsive class generator
type ResponsiveValue = string | number | boolean | Breakpoints;

// Type for class mapping
type ClassMapping = Record<string | number, string>;
